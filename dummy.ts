...
export class PdfDataComponent2 {
  ...
  submitInvoice() {
    ...
    switch (this.submitBtn) {
      case 'Maan Invoice':
        return this.mannInvoice()
      case 'Glitner Invoice':
        return this.glitnerInvoice()
      // case 'sales':
      //   return 
      // case 'bom':
      //   return 
  ...
  mannInvoice() {
    console.log("mann");
    this.excelData = this.excelData.slice(0, 20)
    // console.log('this.excelData: ', this.excelData);
    ...
    let Excel_Details = {
      ...
      payItems: {
        description: this.excelData[18]['__EMPTY'],
        quantity: this.excelData[18]['__EMPTY_1'],
        rates: this.formatter.format(this.excelData[18]['__EMPTY_2']),
        amount: this.formatter.format(this.excelData[18]['__EMPTY_3']),
        totalAmount: this.formatter.format(this.excelData[19]['__EMPTY_3']),
      },
  ...
  glitnerInvoice() {
    console.log("Glitner");
    this.excelData = this.excelData.slice(0, 65)
    console.log('this.excelData: ', this.excelData);

    let Excel_Details = {
      
      invoiceDetails : {
        PRO: Object.keys(this.excelData[0])[0],
        from: {
          name: this.excelData[1]['920773'],
          date: this.excelData[1]['Rate Confirmation'],
          time: this.excelData[1]['__EMPTY'],
          phone: this.excelData[3]['920773'] + ", " + this.excelData[4]['920773'] 
        },
        carrier: {
          name: this.excelData[6]['Rate Confirmation'],
          ATT: this.excelData[6]['__EMPTY'],
          phone: this.excelData[10]['Rate Confirmation'],
          FAX: this.excelData[10]['__EMPTY'],
        }
      //   loadNo: this.excelData[0]['__EMPTY'],
      //   date: this.excelData[1]['__EMPTY'],
      //   address: this.excelData[3]['Customer Invoice'] + " " + this.excelData[4]['Customer Invoice'],
      ...
      logistics : {
        logistics: this.excelData[6]['PRO #'],
        email: this.excelData[8]['PRO #'],
        poBox: this.excelData[9]['PRO #'],
        id: this.excelData[10]['PRO #'],
      },
      pickup : {
        type: 'PickUp',
        company: this.excelData[13]['Rate Confirmation'],
        adderss: this.excelData[14]['Rate Confirmation'] + " " + this.excelData[16]['Rate Confirmation'],
        phone: this.excelData[13]['__EMPTY_3'],
        ShipDateTime: this.excelData[14]['__EMPTY_2'],
        ApptDateTime: this.excelData[15]['__EMPTY_2'],
        specialInst: this.excelData[16]['__EMPTY_2'],
        hours: this.excelData[17]['920773'],
      },
      transport: {
        MC: this.excelData[19]['PRO #'],
        DOT: this.excelData[19]['920773'],
        truck: this.excelData[19]['Rate Confirmation'],
        trailer: this.excelData[19]['__EMPTY'],
        driver: this.excelData[19]['__EMPTY_1'],
        driverCell: this.excelData[19]['__EMPTY_2'],
        PUReference: this.excelData[19]['__EMPTY_3'],
      },
      delivery : {
        type: 'Delivery',
        company: this.excelData[23]['Rate Confirmation'],
        adderss: this.excelData[24]['Rate Confirmation'] + " " + this.excelData[25]['Rate Confirmation'],
        phone: this.excelData[23]['__EMPTY_2'],
        ApptDateTime: this.excelData[25]['__EMPTY_3'],
        reference: this.excelData[26]['__EMPTY_2'],
        hours: this.excelData[26]['920773'],
      },
      payItems: {
        description: this.excelData[28]['PRO #'],
        amount: this.formatter.format(this.excelData[28]['Rate Confirmation']),
        totalAmount: this.formatter.format(this.excelData[36]['920773']),
        // quantity: this.excelData[18]['__EMPTY_1'],
        // rates: this.formatter.format(this.excelData[18]['__EMPTY_2']),
      },
      aa: {
        sizeType: this.excelData[21]['PRO #'],
        Description: this.excelData[21]['__EMPTY_1'],
        pieces: this.excelData[21]['__EMPTY_2'],
        weight: this.excelData[21]['__EMPTY_3'],
        miles: this.excelData[21]['__EMPTY_4'],
      }
